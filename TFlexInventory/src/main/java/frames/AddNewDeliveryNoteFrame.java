 ...
 */
public class AddNewDeliveryNoteFrame extends javax.swing.JFrame {
     ...
     */
    public AddNewDeliveryNoteFrame() {
        //Setting icon
        ...
        deliveryQtyTxt.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent e) {
                String stock = deliveryQtyTxt.getText();
                if (stock.length() > 0) {
                    if (!(new Validation().isInt(stock))) {
                        JOptionPane.showMessageDialog(deliveryQtyTxt, "New stock quantity must be a valid number.", 
                                "Invalid Item Stock Quantity", 2);
                        deliveryQtyTxt.setText(stock.substring(0, stock.length() - 1));
                    } else if (Integer.parseInt(stock) < 0) {
                        JOptionPane.showMessageDialog(deliveryQtyTxt, "New stock quantity cannot be less than 0.", 
                                "Invalid Item Stock Quantity", 2);
                        deliveryQtyTxt.setText(stock.substring(0, stock.length() - 1));
                    }
                }
    ...
    private void initComponents() {
        ...
        deliveryQtyTxt = new javax.swing.JTextField();
        deliveryQtyCombo = new javax.swing.JComboBox();
        ...
        HeaderLbl.setText("Add New Delivery Note");
        ...
        jLabel2.setText("Delivery Quantity");

        deliveryQtyTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deliveryQtyTxtActionPerformed(evt);
            }
        });

        deliveryQtyCombo.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        deliveryQtyCombo.setMaximumRowCount(2);
        deliveryQtyCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "g", "kg", " " }));
        deliveryQtyCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deliveryQtyComboActionPerformed(evt);
            }
        });
        ...
        inventoryTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Category", "Available Stock (g)", "Delivery Quantity (g)", "Final Stock (g)"
            }
        ) {
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(deliveryQtyTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(deliveryQtyCombo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(deliveryQtyTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(deliveryQtyCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void deliveryQtyTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deliveryQtyTxtActionPerformed
        itemAddBtn.requestFocus();
    }//GEN-LAST:event_deliveryQtyTxtActionPerformed

    private void deliveryQtyComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deliveryQtyComboActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_deliveryQtyComboActionPerformed
    ...
    private void itemAddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemAddBtnActionPerformed
        ...
        if (itemsCombo.getSelectedIndex() == -1){
            ...
            itemsCombo.requestFocus();
            itemsCombo.setSelectedIndex(-1);
        } else if (deliveryQtyTxt.getText().equals("")) {
            JOptionPane.showMessageDialog(deliveryQtyTxt, "Please enter item stock quantity to add.", 
                    "Empty Item Stock Quantity", 2);
            deliveryQtyTxt.requestFocus();
        } else if (parseInt(deliveryQtyTxt.getText()) <= 0) {
            JOptionPane.showMessageDialog(deliveryQtyTxt, "Item stock quantity cannot be 0!", 
                    "Invalid item stock Quantity", 2);
            deliveryQtyTxt.requestFocus();
            ...
            int deliveryQty = parseInt(deliveryQtyTxt.getText());
            if (deliveryQtyCombo.getSelectedItem().equals("kg")) {
                deliveryQty *= 1000;
            }
            boolean isNew = true, error = false;
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                */
                if (itemName.equals(inventoryTable.getValueAt(i, 1))) {
                    ...
                    deliveryQty += parseInt(inventoryTable.getValueAt(i, 4).toString());
                    
                    //check if delivery qty exeeds stock qty
                    if (deliveryQty > availableStock) {
                        JOptionPane.showMessageDialog(deliveryQtyTxt, "Collective delivery quantity cannot be greater than stock quantity.", 
                                "Invalid Delivery Quantity", 2);
                        deliveryQtyTxt.setText("");
                        deliveryQtyTxt.requestFocus();
                        error = true;
                    } else {
                        inventoryTable.setValueAt(formatNum(deliveryQty), i, 4);
                        //calculating new stock qty
                        inventoryTable.setValueAt(formatNum(availableStock - deliveryQty), i, 5);
                    }
            ...
            if (isNew) {
                ...
                itemRecord.next();
                Float availableStock = parseFloat(itemRecord.getString(2));
                //check if delivery qty exeeds stock qty
                if (deliveryQty > availableStock) {
                    JOptionPane.showMessageDialog(deliveryQtyTxt, "Delivery quantity cannot be greater than stock quantity.", 
                            "Invalid Delivery Quantity", 2);
                    deliveryQtyTxt.setText("");
                    deliveryQtyTxt.requestFocus();
                    error = true;
                    ...
                    newRow.addElement(deliveryQty);
                    newRow.addElement(availableStock - deliveryQty);
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        if (dialogResult == JOptionPane.YES_OPTION){
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                ti.addNewTransactionItem(tid, inventoryTable.getValueAt(i, 0).toString(), 1, inventoryTable.getValueAt(i, 4).toString());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewDeliveryNoteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewDeliveryNoteFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox deliveryQtyCombo;
    private javax.swing.JTextField deliveryQtyTxt;
